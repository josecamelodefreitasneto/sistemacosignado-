...
import ClienteStatus from '../../cruds/clienteStatus/ClienteStatus';
...
export default class ClienteStatusUtilsAbstract {
	checkInstance() {
		Sessao.checkInstance("ClienteStatusUtils", this);
	}
	init() {}
	equalsNome(a, b) {
