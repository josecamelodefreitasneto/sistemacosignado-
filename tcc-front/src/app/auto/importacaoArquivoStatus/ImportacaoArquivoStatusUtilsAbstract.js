...
import ImportacaoArquivoStatus from '../../cruds/importacaoArquivoStatus/ImportacaoArquivoStatus';
...
export default class ImportacaoArquivoStatusUtilsAbstract {
	checkInstance() {
		Sessao.checkInstance("ImportacaoArquivoStatusUtils", this);
	}
	init() {}
	equalsNome(a, b) {
	...
	fromJson(json) {
		...
		let o = new ImportacaoArquivoStatus();
		o.setId(json.id);
