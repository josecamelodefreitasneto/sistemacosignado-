...
export default class ClienteTipoEditAbstract extends FormEdit {
	init2() {
		this.init3();
	}
	constructor(props) {
		super(props);
		this.init("ClienteTipo", ClienteTipoCampos.getInstance());
	}
	getTabs() {
		return (
			<Tabs
...
ClienteTipoEditAbstract.defaultProps = FormEdit.defaultProps;
