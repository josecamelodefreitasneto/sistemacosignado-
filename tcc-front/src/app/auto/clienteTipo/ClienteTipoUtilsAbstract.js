...
import ClienteTipo from '../../cruds/clienteTipo/ClienteTipo';
...
export default class ClienteTipoUtilsAbstract {
	checkInstance() {
		Sessao.checkInstance("ClienteTipoUtils", this);
	}
	init() {}
	equalsNome(a, b) {
