...
export default class ClienteTipoSimulacaoEditAbstract extends FormEdit {
	init2() {
		this.init3();
	}
	constructor(props) {
		super(props);
		this.init("ClienteTipoSimulacao", ClienteTipoSimulacaoCampos.getInstance());
	}
	getTabs() {
		return (
			<Tabs
...
ClienteTipoSimulacaoEditAbstract.defaultProps = FormEdit.defaultProps;
