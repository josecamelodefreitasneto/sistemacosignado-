...
import br.auto.select.FilaScriptsSelect;
...
public abstract class FilaScriptsServiceAbstract extends ServiceModelo<FilaScripts> {
	...
	@Override
	public MapSO toMap(final FilaScripts o, final boolean listas) {
		MapSO map = new MapSO();
		map.put("id", o.getId());
	...
	@Override
	protected final void validar(final FilaScripts o) {
	...
	public void validarUniqueSqlOperacao(final FilaScripts o) {
	...
	@Override
	protected ResultadoConsulta consultaBase(final MapSO params, FTT<MapSO, FilaScripts> func) {
	...
	@Override
	protected FilaScripts buscaUnicoObrig(final MapSO params) {
		final FilaScriptsSelect<?> select = select();
	...
	@Override
	protected FilaScripts setOld(final FilaScripts o) {
	...
	public FilaScriptsSelect<?> select(final Boolean excluido) {
	...
	@Override
	protected void setBusca(final FilaScripts o) {
		String s = getText(o);
		s = UString.toCampoBusca(s);
		o.setBusca(s);
	}
	@Override
	public String getText(final FilaScripts o) {
