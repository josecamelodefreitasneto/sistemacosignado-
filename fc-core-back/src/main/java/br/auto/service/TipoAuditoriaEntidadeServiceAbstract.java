...
public abstract class TipoAuditoriaEntidadeServiceAbstract extends ServiceModelo<TipoAuditoriaEntidade> {
	...
	@Override
	public MapSO toMap(final TipoAuditoriaEntidade o, final boolean listas) {
		MapSO map = new MapSO();
		map.put("id", o.getId());
	...
	@Override
	protected TipoAuditoriaEntidade buscaUnicoObrig(final MapSO params) {
	...
	@Override
	public String getText(final TipoAuditoriaEntidade o) {
		if (o == null) return null;
		return o.getNome();
	}

	@Override
	public TipoAuditoriaEntidade findNotObrig(final int id) {
		return map.get(id);
	}
