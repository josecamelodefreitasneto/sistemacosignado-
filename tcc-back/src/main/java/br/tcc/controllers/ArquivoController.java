...
@RestController @RequestMapping(value = "arquivo/")
public class ArquivoController extends ControllerModelo {
	...
	private File getFile(Arquivo arquivo) {
		final String fileName = getService().getFileName(arquivo);
		final File file = new File(fileName);
		return file;
	}

	private Arquivo getArquivo(String extensao, final String checksum) {
