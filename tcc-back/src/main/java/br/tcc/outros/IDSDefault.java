...
public class IDSDefault {
	...
	public static final class AnoMes {
		public static final int idEntidade = 7;
	...
	public static final class ConsultaOperador {
		public static final int idEntidade = 34;
		public static final int nome = 83;
	}
	public static final class Dia {
		public static final int idEntidade = 16;
		public static final int data = 32;
		public static final int nome = 33;
		public static final int diaDaSemana = 34;
		public static final int anoMes = 35;
		public static final int feriado = 36;
		public static final int diaUtil = 37;
	}
