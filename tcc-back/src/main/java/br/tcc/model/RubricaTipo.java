...
@Getter @Setter
public class RubricaTipo extends EntityModelo {
	...
	@Override
	public RubricaTipo getOld() {
		return (RubricaTipo) super.getOld();
	}

	public RubricaTipo(final int id, final String nome) {
		this.id = id;
		this.nome = nome;
	}
}
