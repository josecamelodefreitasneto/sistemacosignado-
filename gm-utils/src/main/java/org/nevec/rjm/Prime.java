...
public class Prime {
	...
	/**
	 * Default constructor initializing a list of primes up to 17. 17 is enough to
	 * call the Miller-Rabin tests on the first 7 primes without further action.
	 * 
	 * @author Richard J. Mathar
	 */
	public Prime() {
	 ...
	 * @param n the integer to be tested for primality
	 * @param a the base
	 * @return true if the test is passed, so n may be a prime. false if the test is
	 *         not passed, so n is not a prime.
	 * @author Richard J. Mathar
	 * @since 2010-02-25
	 */
	...
	public BigInteger at(int i) {
		/*
		 * If the current list is too small, increase in intervals of 5 until the list
	 ...
	 * @return 0 if n is less than 2; 1 if n=2; 2 if n=3 or 4; 3 if n=5 or 6; and so
	 *         forth.
	 * @author Richard J. Mathar
	 */
	...
	public BigInteger nextprime(BigInteger n) {
		...
		/*
		 * If the currently largest element in the list is too small, increase in
		 * intervals of 5 until the list has at least i elements.
		 */
	 ...
	 * 
	 * @param args This takes a single argument (n) and prints prime(n), the
	 *             previous and next prime, and pi(n).
	 * @since 2006-08-14
	 * @author Richard J. Mathar
	 */
