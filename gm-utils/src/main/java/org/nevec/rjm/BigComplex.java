...
public class BigComplex {
	 ...
	 *         imaginary part of the result has the same sign as the imaginary part
	 *         of this. Tim Ahrendt,
	 *         <a href="http://dx.doi.org/10.1145/236869.236924">Fast High-precision
	 *         computation of complex square roots</a>, ISSAC 1996 p142-149.
	 * @since 2008-10-27
	 * @author Richard J. Mathar
	 */
	BigComplex sqrt(MathContext mc) {
		...
		/*
		 * compute l=sqrt(re^2+im^2), then u=sqrt((l+re)/2) and v= +- sqrt((l-re)/2 as
