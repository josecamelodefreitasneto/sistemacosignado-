...
/**
 * Fractions (rational numbers). They are ratios of two BigInteger numbers,
...
public class Rational implements Cloneable, Comparable<Rational> {
	 ...
	 *            integers, or, if there is no slash, is representing the numerator
	 *            with implicit denominator equal to 1. Warning: this does not yet
	 ...
	 *              numerator.
	 * @param radix the number base for numerator and denominator Warning: this does
	 *              not yet test for a denominator equal to zero
	 * @author Richard J. Mathar
	 */
	...
	/**
	 * ctor from a terminating continued fraction. Constructs the value of
	 * cfr[0]+1/(cfr[1]+1/(cfr[2]+...))).
	 * 
	 * @param cfr The coefficients cfr[0], cfr[1],... of the continued fraction. An
	 *            exception is thrown if any of these is zero.
	 * @since 2012-03-08
	 * @author Richard J. Mathar
	 */
	public Rational(Vector<BigInteger> cfr) {
		if (cfr.size() == 0)
			 ...
			 * this = cfr[0]+rec.b/rec.a = (cfr[0]*rec.a+rec.b)/rec.a . Create a cloned
			 * version of references to cfr, without cfr[0]
			 */
	...
	public Rational clone() {
		/*
		 * protected access means this does not work return new Rational(a.clone(),
		 * b.clone());
		 */
	...
	public Rational multiply(final Rational val) {
		...
		/*
		 * Normalization to an coprime format will be done inside the ctor() and is not
		 * duplicated here.
		 */
	 ...
	 * @return this value raised to the power given by the exponent. If the exponent
	 *         is 0, the value 1 is returned.
	 * @author Richard J. Mathar
	 */
	 ...
	 * r-th root.
	 * 
	 * @param r the inverse of the exponent. 2 for the square root, 3 for the third
	 *          root etc
	 * @return this value raised to the inverse power given by the root argument,
	 *         this^(1/r).
	 * @since 2009-05-18
	 * @author Richard J. Mathar
	 */
	...
	public int compareTo(final Rational val) {
		/*
		 * Since we have always kept the denominators positive, simple cross-multiplying
		 * works without changing the sign.
		 */
	...
	public double doubleValue() {
		/*
		 * To meet the risk of individual overflows of the exponents of a separate
		 * invocation a.doubleValue() or b.doubleValue(), we divide first in a
		 * BigDecimal environment and convert the result.
		 */
	 ...
	 * 
	 * @param mc the mathematical context which determines precision, rounding mode
	 *           etc
	...
	public BigDecimal BigDecimalValue(MathContext mc) {
		 ...
		 * smaller than what is set by mc if the value has a precise truncated
		 * representation. 1/4 will appear as 0.25, independent of mc
		 */
	...
	/**
	 * True if the value is a fraction of two integers in the range of the standard
	 * integer.
	 * 
	 * @since 2010-05-26
	 * @author Richard J. Mathar
	...
	/**
	 * The sign: 1 if the number is larger than zero, 0 if it equals zero, -1 if it
	 ...
	 * 
	 * @return The list of a0, a1, a2,... in this =a0+1/(a1+1/(a2+1/(a3+...)))). If
	 *         this here is zero, the list is empty.
	 * @since 2012-03-09
	 * @author Richard J. Mathar
	 */
	 ...
	 * @author Richard J. Mathar
	 */
	public static BigInteger lcmDenom(final Rational[] vals) {
	 ...
	 * @return the sum of the inverses of the integers from 1 to n. H_1=1 for n=1,
	 *         H_2=3/2 for n=2 etc. For values of n less than 1, zero is returned.
	 * @since 2008-10-19
	 * @author Richard J. Mathar
	 * @author Richard J. Mathar
	 */
	...
	/**
	 * Normalize to coprime numerator and denominator. Also copy a negative sign of
